    ...
    return (
        <div className="w-full bg-gradient-to-b from-[#FFBBEC] to-[#A9C9FF] py-16 overflow-hidden">
            <div className="w-full mx-auto md:px-16">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-black">What our customers are saying about us</h2>
                ...
                <div className="relative overflow-visible">
                        ...
                        {testimonials.map((testimonial) => (
                            <SwiperSlide key={testimonial.id} className="!overflow-visible">
                                <div className="min-w-[300px] max-w-[400px] h-[350px] bg-white hover:bg-[#FFB020] rounded-xl p-8 shadow-lg transform transition-all duration-300 hover:scale-105 hover:z-20">
                                    ...
                                    <h4 className="text-xl font-bold mb-4 text-black">{testimonial.title}</h4>
                    ...
                    <div className='w-full flex justify-center mt-8 gap-24'>
                        ...
                        >
                            <svg className="w-8 h-8 text-[#8A58FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
