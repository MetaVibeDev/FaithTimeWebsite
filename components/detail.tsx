...
export default function Detail() {
    ...
    return <div className="w-full flex justify-center bg-white overflow-hidden ">
        <div className="relative w-[1200px]">
            ...
            <div className="relative w-full">
                ...
                <div className="w-full absolute md:top-24  top-8 px-8 lg:px-0 flex flex-col  lg:gap-64 md:gap-64 sm:gap-32 ">

                    <section className="relative w-full px-4 ">
                        <div className="absolute z-2 -top-48  right-0 hidden md:flex"> <Lumi animation="love" color="white" size={300} />
                        </div>
                    ...
                    <section className="relative w-full  px-4">
                        <div className="absolute z-2 -top-48 md:left-0 hidden md:flex"> <Lumi animation="happy" color="white" size={300} />
                        </div>
                    ...
                    <section className="relative w-full px-4">
                        <div className="absolute z-2 -top-48  right-0 hidden md:flex"> <Lumi animation="think" color="white" size={300} />
                        </div>
                    ...
                    <section className="relative w-full  px-4">
                        <div className="absolute z-2 -top-48  md:left-0 hidden md:flex"> <Lumi animation="think" color="white" size={300} />
                        </div>
                        <div className="relative w-full mx-auto flex flex-row items-center lg:items-start gap-12">
                            <div className="md:w-1/2 w-2/5 flex justify-center" >
                                <div className="border-4 border-solid border-black rounded-3xl md:w-[50%] overflow-hidden w-[80%]">
