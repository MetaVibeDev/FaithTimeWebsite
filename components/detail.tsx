...
export default function Detail() {
  ...
  const arr2 = ["/images/screen-6.png", "/images/screen-7.png"];
  const arr3 = [
    "/images/screen-8.png",
    "/images/screen-9.png",
  ...
  return (
    <div className="w-full lg:px-16 flex justify-center bg-white overflow-hidden ">
      <div className="relative w-[1200px]">
        <div className="font-bold lg:text-[56px] px-8 lg:px:0 text-3xl text-black text-center lg:mt-[88px] mt-12">
          Faith-Fueled Features You'll Love
        </div>
        <div className="font-normal text-[16px] mt-8 px-8 lg:px:0 text-black text-center">
          ...
          <div className="w-full absolute md:top-24 top-16 flex flex-col lg:gap-64 md:gap-64 sm:gap-12 gap-8 px-4">
              ...
              <div className="relative z-2 w-full mx-auto flex flex-row items-center lg:items-start gap-12 ">
                <div className="md:w-1/2 w-3/5 space-y-6 flex-col flex gap-4">
                  <h2
                    ...
                    style={{ lineHeight: width > 800 ? "2.5rem" : "1.5rem" }}
                  >
                    Walk the Path as the Little Lamb — Grow, Reflect, and Glow
                    in Faith!
                  </h2>
                  <p className="lg:text-lg text-sm text-[#2F106D] md:flex hidden">
                    We creates a warm and mindful space for your spiritual
                    growth. With Devotion Tracking, you'll build a steady,
                    devout routine. Day & Night Themes set the mood for prayer,
                    morning to night. And your animated lamb? It cheers you on,
                    celebrates your progress, and grows with you — a joyful
                    reminder that faith is a journey, not a checklist.
                  </p>
                  <div className="flex justify-start">
                    <button
                      ...
                      className="bg-[#8A58FF] text-white text-[10px] md:text-xl md:px-8 md:py-3 p-3 rounded-full hover:bg-purple-700 transition-colors"
                    >
                      Get Started
                    </button>
                  </div>
            ...
            >
              ...
              <div className="relative z-1 max-w-7xl mx-auto flex flex-row items-center lg:items-start gap-12">
                ...
                <div className="md:w-1/2 w-3/5 space-y-6 flex-col flex gap-4">
                  <h2
                    className="lg:text-[32px] md:text-xl text-sm font-semibold leading-tight text-black"
                    style={{ lineHeight: width > 800 ? "2.5rem" : "1.5rem" }}
                  >
                    You're Not Alone — Share, Pray, Connect!
                  </h2>
                  <p className="lg:text-lg text-sm text-[#2F106D] md:flex hidden">
                    This is your space to open up, ask for prayer, and lift
                    others up too. Share what's on your heart, join meaningful
                    conversations, or offer encouragement through prayer. Here,
                    faith becomes community — real, supportive, and alive.
                  </p>
              ...
              <div className="relative z-2 w-full mx-auto flex flex-row items-center lg:items-start gap-12 ">
                <div className="md:w-1/2 w-3/5 space-y-6 flex-col flex gap-4">
                  <h2
                    ...
                    style={{ lineHeight: width > 800 ? "2.5rem" : "1.5rem" }}
                  >
                    Daily Devotions — Grow Closer to God Every Day!
                  </h2>
                  <p className="lg:text-lg text-sm text-[#2F106D] md:flex hidden">
                    Strengthen your faith with our daily devotions. Each day
                    brings new insights, prayers, and reflections to deepen your
                    spiritual journey. Set aside time for God and watch your
                    relationship with Him flourish through consistent,
                    meaningful devotional practice.
                  </p>
                  <div className="flex justify-start">
                    <button
                      onClick={() =>
              ...
              <div className="relative z-1 max-w-7xl mx-auto flex flex-row items-center lg:items-start gap-12">
                ...
                <div className="md:w-1/2 w-3/5 space-y-6 flex-col flex gap-4">
                  <h2
                    ...
                    style={{ lineHeight: width > 800 ? "2.5rem" : "1.5rem" }}
                  >
                    Bible Study Made Simple — Discover God's Word!
                  </h2>
                  <p className="lg:text-lg text-sm text-[#2F106D] md:flex hidden">
                    Dive into Scripture with our easy-to-use Bible study tools.
                    Access verses, take notes, and explore commentaries all in
                    one place. Whether you're a beginner or seasoned believer,
                    our app makes studying the Bible accessible, engaging, and
                    transformative.
                  </p>
                  <div className="flex justify-end">
                    <button
